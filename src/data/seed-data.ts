...
const PRODUCT_PRICES: Record<string, number> = {
  ...
  "0-5hp-inchi-bearing-jawed-pump": 9000,
  "0-5hp-inchi-bearing-diamond-pump": 11000,
...
export const products: SeedProduct[] = [
  ...
  product({
    name: "ESPA M4 Multistage",
    slug: "espa-m4-multistage",
    sku: "IMP-ESPA-M4",
    brand: "Imported",
    categorySlug: "monoblock-pressure-pumps",
    shortDescription: "Imported ESPA M4 stainless steel multistage pump. 1.1 kW, 220 V.",
    description:
      "Pumping of clean water for domestic, industrial, agricultural and gardening purposes. Suitable for applications like water transfer, sprinkler or drip irrigation, domestic booster or booster sets. Silent. Self-priming up to 2m.\n\nApplications:\n• High-Pressure Water Supply: Ideal for multi-storey buildings, apartments, and commercial complexes requiring strong and consistent pressure.\n• Pressure Boosting Systems: Used in booster sets where higher head and flow are needed.\n• Agricultural & Irrigation Systems: Suitable for sprinkler irrigation, drip systems, and water distribution in farms.\n• Industrial Water Transfer: For clean water circulation in factories, processing units, and workshops.\n• Commercial Facilities: Hotels, hospitals, schools, malls, and office buildings.",
    tags: ["espa", "m4", "multistage", "imported", "stainless", "booster"],
    specs: {
      Model: "ESPA M4 Multistage",
      Voltage: "220 V",
      Frequency: "50 Hz",
      Phase: "Single-phase",
      "Motor Power (P1)": "1.1 kW",
      Current: "6.8 A",
      Capacitor: "15 μF",
      "Number of Poles": "2",
      ...
      Impellers: "Stainless Steel AISI 304 (4)",
      "Pump Shaft": "Stainless Steel AISI 420",
      "Suction Body": "Cast Iron",
      "Discharge Body": "Cast Iron",
      Diffusers: "Technopolymer",
      "Suction Diameter": "1\" threaded",
      "Discharge Diameter": "1\" threaded",
      "Seal Type": "Mechanical seal",
      "Motor Cooling": "Fan-cooled",
      "Maximum Suction Lift": "2 m",
      "Maximum Water Temperature": "40 °C",
      Brand: "ESPA (Imported)",
    },
    imageSeed: "espa-m4",
    images: pm("espa-m4-multistage", "cover.jpg"),
  }),
  product({
    name: "Mhf-5AM 2x2 Monoblock pressure pump china imported",
    slug: "mhf-5am-2x2-monoblock-pressure-pump",
    sku: "IMP-MHF-5AM",
    brand: "Imported",
    categorySlug: "monoblock-pressure-pumps",
    shortDescription: "Imported Mhf-5AM 2x2 monoblock centrifugal pressure pump. 2 HP, 220 V.",
    description:
      "The MHF/5AM centrifugal electric pump is a single-phase, 2 HP (1.5 kW) surface water pump designed for clean water transfer, irrigation, and general supply applications. It can deliver up to about 420 L/min of flow with a maximum head of around 22.5 m. The pump typically features 2\" inlet/outlet connections, a cast-iron body with a brass impeller, and runs on standard 220 V, 50 Hz power, with an external ventilated motor and built-in thermal protection for continuous operation.\n\nApplications:\n• Domestic water supply and pressure boosting\n• Garden, lawn, and agricultural irrigation\n• Water transfer from tanks, canals, rivers, or reservoirs\n• Light industrial circulation and cooling systems",
    tags: ["mhf", "5am", "monoblock", "pressure", "imported", "china", "2hp", "2x2"],
    specs: {
      Model: "Mhf-5AM",
      Type: "Single-stage centrifugal monoblock",
      Voltage: "220 V",
      Frequency: "50 Hz",
      Phase: "Single-phase",
      Power: "2.0 HP / 1.5 kW",
  ...
  product({
    ...
    brand: "Imported",
    categorySlug: "monoblock-pressure-pumps",
    shortDescription: "Imported Pedrollo CPM 158 1HP centrifugal monoblock. 0.75 kW, Italy.",
    description:
      "The Pedrollo CPM 158 1HP pump is a reliable centrifugal surface pump designed for clean water applications. It is a 1 HP (0.75 kW) non-self-priming pump that can deliver up to about 90 litres per minute with a maximum head of around 34–36 m. Built with durable materials like cast iron and stainless steel, it is suitable for household water supply, tank filling, and garden irrigation in domestic and small commercial settings thanks to its strong pressure and continuous-duty performance. It requires priming and is not suitable for dirty or sandy water.\n\nThis pump is designed for clean water only (no sand, mud, or chemicals).\n\nCommon uses:\n• House water supply / boosting\n• Overhead tank filling\n• Garden irrigation\n• Small farms & orchards\n• Water transfer between tanks\n• Pressure systems with pressure tank",
    tags: ["cpm158", "pedrollo", "monoblock", "pressure", "imported", "italy", "1hp"],
    specs: {
      Model: "Pedrollo CPM 158",
      Type: "Centrifugal surface pump (non-self-priming)",
      Voltage: "220–240 V",
      Phase: "Single-phase",
      Power: "1 HP (0.75 kW)",
      "Max Flow Rate": "90 L/min (≈ 5.4 m³/h)",
      "Max Head": "34–36 m",
      "Suction Lift": "Up to 7 m",
      Pressure: "≈ 3.6 bar max",
      "Inlet / Outlet": "1\" x 1\"",
      "Pump Body": "Cast iron",
      Impeller: "Brass",
      "Impeller Type": "Single impeller centrifugal",
      "Duty Cycle": "Continuous (S1)",
      Performance: "≈ 90 L/min at 25 m head; ≈ 10 L/min at 34 m head",
      Brand: "Pedrollo (Imported)",
      Origin: "Italy",
    },
    imageSeed: "cpm158",
    images: pm("cpm158-1hp-monoblock-pressure-pump", "cover.jpg", "gallery-01.jpg"),
  }),
  product({
    name: "Cpm158 1hp monoblock pressure pump china imported",
    slug: "cpm158-1hp-monoblock-pressure-pump-china",
    sku: "IMP-CPM158-CN",
    brand: "Imported",
    categorySlug: "monoblock-pressure-pumps",
    shortDescription: "Imported CPM 158 1HP centrifugal monoblock pressure pump. China, 220 V.",
    description:
      "The CPM 158 centrifugal electric pump is a single-phase, 1 HP surface pump designed for pumping clean water in domestic and light commercial applications. It delivers a reliable flow with a maximum head of around 31 meters, making it suitable for water supply systems, garden irrigation, and pressure boosting. Built with a cast-iron body and stainless-steel impeller, it offers durability and continuous operation, while operating on standard 220V power.\n\nApplications:\n• Domestic water supply\n• Garden and greenhouse irrigation\n• Pressure boosting with tanks/pressure sets\n• General liquid transfer (clean water systems)",
    tags: ["cpm158", "monoblock", "pressure", "imported", "china", "1hp"],
    specs: {
      Model: "CPM 158",
      ...
      Current: "~5.2 A",
      Capacitor: "~25 µF",
      "Max Head": "approx. 31 m",
      "Typical Operating Head": "~25–34 m",
      "Max Flow Rate": "up to ~97 L/min",
      "Inlet / Outlet": "1\" x 1\" threaded",
      "Pump Body": "Cast iron",
      Impeller: "Brass",
      "Drive Shaft": "Iron",
      Dimensions: "~33 x 24 x 28 cm (L × W × H)",
      Weight: "~12 kg",
      Brand: "Imported",
      Origin: "China",
    },
