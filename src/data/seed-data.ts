...
export const products: SeedProduct[] = [
  ...
  product({
    ...
    specs: { Power: "1 HP", Type: "Monoblock Pressure Pump", Brand: "Jawed", Warranty: "1 Year" },
    imageSeed: "mb-jw-1",
  ...
  product({
    ...
    specs: { Power: "0.5 HP", Type: "Monoblock Pressure Pump", Brand: "Premium", Warranty: "1 Year" },
    imageSeed: "mb-pr-05",
  ...
  product({
    ...
    specs: { Power: "1 HP", Type: "Monoblock Pressure Pump", Brand: "Premium", Warranty: "1 Year" },
    imageSeed: "mb-pr-1",
